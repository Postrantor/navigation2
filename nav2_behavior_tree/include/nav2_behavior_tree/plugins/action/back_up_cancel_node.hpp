...
/**
 * @brief 一个包装 nav2_msgs::action::BackUp 的 nav2_behavior_tree::BtActionNode 类 (A nav2_behavior_tree::BtActionNode class that wraps nav2_msgs::action::BackUp)
 */
...
public:
   ...
   * @return 返回包含基本端口以及节点特定端口的 BT::PortsList (BT::PortsList Containing basic ports along with node-specific ports)
   */
