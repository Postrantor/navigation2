...
/**
 * @brief 一个封装了 nav2_msgs::action::FollowPath 的 nav2_behavior_tree::BtActionNode 类 (A nav2_behavior_tree::BtActionNode class that wraps nav2_msgs::action::FollowPath)
 */
...
public:
   ...
   * @param xml_tag_name 用于此节点的 XML 标签名称 (Name for the XML tag for this node)
